...
function createSuggestions(artistName) {
    ...
    .then(function (data) {
        ...
        if (data.length > 5) {
            ...
            window.open(this.val,"file:///C:/Users/britt/OneDrive/Desktop/TestTeams/index.html" ) = this.val;
        });
    });
}
...
chordsButton.click(function() {
    ...
    window.open(chordURL,"file:///C:/Users/britt/OneDrive/Desktop/TestTeams/index.html") = chordURL;
})